...
public class ResultSetSpy implements ResultSet, Spy
{
  ...
  @Override
public void updateObject(final int columnIndex, Object x, SQLType targetSqlType,
		int scaleOrLength) throws SQLException {
	  final String methodCall = "updateObject(" + columnIndex+","+x+"," +targetSqlType+","+scaleOrLength+")";
	   try
	    {
...
public void updateObject(final String columnLabel,final  Object x,final SQLType targetSqlType,
		int scaleOrLength) throws SQLException {
	  final String methodCall = "updateObject(" + columnLabel+","+x+"," +targetSqlType+","+scaleOrLength+")";
	   try
	    {
...
public void updateObject(final int columnIndex, final Object x, final SQLType targetSqlType)
		throws SQLException {
	  final String methodCall = "updateObject(" + columnIndex+","+x+"," +targetSqlType+ ")";
	    try
	    {
...
public void updateObject(final String columnLabel, final Object x, final SQLType targetSqlType)
		throws SQLException {
	  final String methodCall = "updateObject(" + columnLabel+","+x+"," +targetSqlType+ ")";
	    try
	    {
