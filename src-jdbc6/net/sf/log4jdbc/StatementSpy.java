...
public long getLargeUpdateCount() throws SQLException {
	  final String methodCall = "getLargeUpdateCount()";
	    try
	    {
	    	 return (Long) reportReturn(methodCall,  realStatement.getLargeUpdateCount());
	    }
...
public void setLargeMaxRows(final long max) throws SQLException {
	  final String methodCall = "setLargeMaxRows("+max+")";
	    try
	    {
...
public long getLargeMaxRows() throws SQLException {
	  final String methodCall = "getLargeMaxRows()";
	    try
	    {
	    	 return (Long) reportReturn(methodCall,  realStatement.getLargeMaxRows());
	    }
	    catch (SQLException s)
	    {
	      reportException(methodCall, s);
...
public long[] executeLargeBatch() throws SQLException {
	  String methodCall = "executeLargeBatch()";
	    try
	    {
	    	 return (long[]) reportReturn(methodCall,  realStatement.executeLargeBatch());
	    }
	    catch (SQLException s)
	    {
	      reportException(methodCall, s);
...
public long executeLargeUpdate(String sql) throws SQLException {
	  String methodCall = "executeLargeUpdate("+sql+")";
	    try
	    {
	    	 return (Long) reportReturn(methodCall,  realStatement.executeLargeUpdate(sql));
	    }
	    catch (SQLException s)
	    {
	      reportException(methodCall, s);
...
public long executeLargeUpdate(String sql, int autoGeneratedKeys)
	  ...
	  String methodCall = "executeLargeUpdate("+sql+","+autoGeneratedKeys+")";
	    try
	    {
	    	 return (Long) reportReturn(methodCall,  realStatement.executeLargeUpdate(sql,autoGeneratedKeys));
	    }
	    catch (SQLException s)
	    {
	      reportException(methodCall, s);
...
public long executeLargeUpdate(String sql, int[] columnIndexes)
	  ...
	  String methodCall = "executeLargeUpdate("+sql+","+columnIndexes+")";
	    try
	    {
	    	 return (Long) reportReturn(methodCall,  realStatement.executeLargeUpdate(sql,columnIndexes));
	    }
	    catch (SQLException s)
	    {
	      reportException(methodCall, s);
...
public long executeLargeUpdate(String sql, String[] columnNames)
	  ...
	  String methodCall = "executeLargeUpdate("+sql+","+columnNames+")";
	    try
	    {
	    	 return (Long) reportReturn(methodCall,  realStatement.executeLargeUpdate(sql,columnNames));
	    }
	    catch (SQLException s)
	    {
	      reportException(methodCall, s);
