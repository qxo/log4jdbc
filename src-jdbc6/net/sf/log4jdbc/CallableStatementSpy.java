 ...
 * @author Arthur Blake
 */
public final class CallableStatementSpy extends PreparedStatementSpy implements CallableStatement
{
...
public void setObject(final String parameterName, final Object x, final SQLType targetSqlType,
	...
	final String methodCall = "setObject(" + parameterName + ", " + x + ","+targetSqlType+","+scaleOrLength+")";
    try
    {
...
public void setObject(final String parameterName,final Object x,final SQLType targetSqlType)
		throws SQLException {
	final String methodCall = "setObject(" + parameterName + ", " + x + ","+targetSqlType+")";
    try
    {
...
public void registerOutParameter(final int parameterIndex,final SQLType sqlType)
		throws SQLException {
	final String methodCall = "registerOutParameter(" + parameterIndex + ", " +sqlType+")";
    try
    {
...
public void registerOutParameter(int parameterIndex, SQLType sqlType, int scale)
		throws SQLException {
	final String methodCall = "registerOutParameter(" + parameterIndex + ", " +sqlType+","+scale+")";
    try
    {
...
public void registerOutParameter(final int parameterIndex,final SQLType sqlType,
	...
	final String methodCall = "registerOutParameter(" + parameterIndex + ", " +sqlType+","+typeName+")";
    try
    {
...
public void registerOutParameter(String parameterName, SQLType sqlType)
		throws SQLException {
	final String methodCall = "registerOutParameter(" + parameterName + ", " +sqlType+")";
    try
    {
...
public void registerOutParameter(final String parameterName,final SQLType sqlType,
	...
	final String methodCall = "registerOutParameter(" + parameterName + ", " +sqlType+","+scale+")";
    try
    {
...
public void registerOutParameter(final String parameterName, final SQLType sqlType,
		final String typeName) throws SQLException {
	final String methodCall = "registerOutParameter(" + parameterName + ", " +sqlType+","+typeName+")";
    try
    {
